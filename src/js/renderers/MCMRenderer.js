...
constructor(gl, volume, camera, environmentTexture, options = {}) {
    ...
    //this._programs2 = WebGL.buildPrograms(gl, SHADERS.renderers.MIP, MIXINS);
...
_resetFrame() {
    ...
    //gl.bindTexture(gl.TEXTURE_2D, this._MIPmap);

    if(this._context._MIPmap == null) {
        gl.bindTexture(gl.TEXTURE_2D, this._context._MIPmap);
        console.log("NO GO");
    }
    else {
        gl.bindTexture(gl.TEXTURE_2D, this._context._MIPmap.color[0]);
    }
